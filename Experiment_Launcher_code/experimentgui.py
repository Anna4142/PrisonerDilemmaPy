...
class ExperimentGUI:
    def __init__(self):
        ...
        self.experiment_name = tk.StringVar(value = "Experiment_3")
        ...
        self.return_time_var = tk.StringVar(value = "10")
        self.decision_time_var = tk.StringVar(value = "10")
        self.mouse_1_id = tk.StringVar(value="9320")
        self.mouse_2_id = tk.StringVar(value="9321")
